...
public class RecoverableWordCount {
	 private static final Pattern SPACE = Pattern.compile(" ");
	  ...
	  private static JavaStreamingContext createContext(String ip,
	    ...
	    SparkConf sparkConf = new SparkConf().setMaster("local[*]") .setAppName("JavaRecoverableNetworkWordCount");
	  ...
	  public static void main(String[] args) throws Exception {
	    ...
	    String checkpointDirectory = "/home/bizruntime/eclipse-workspace/sparkstream/stream2/checkpoints";
	    String outputPath = "/home/bizruntime/eclipse-workspace/sparkstream/stream2/output_example";
	  ...
	  static class JavaWordBlacklist {
	  ...
	  static class JavaDroppedWordsCounter {
